...
**Agencies** – companies that re-sell your travel products to end consumers. The main concept is that they can only sell using sales terms that you configure for them in advance, and usually they get commission that is being configured within the contact with them.
...
**Corporate Clients** – organisations that require travel services for their own employees or partners. By using GP Travel Enterprise, you can manage business trips and incentive travel for corporate clients, sell travel products and services to them, keep a record of such clients and set specific sales terms for each of them.
