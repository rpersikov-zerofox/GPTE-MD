...
**Swagger** [Swagger UI](http://demo.softwaretravel.net/gptp/stat/swagger/index.html)
...
2. After you select the check box, the ![2024-10-28\_22-41-16.png](blob:https://gp-team.atlassian.net/9c7e16a9-0e64-4ea0-81e1-4a26e2bda520) symbol appears. Click it to expand the **Export configurations** form.
3.  3\. In the **Export configurations** form, fill in the required data:
    ...
    * **Protocol**: ways of sending the information.
    ...
    If needed, you can specify several external applications. Click ![2024-10-28\_22-41-16.png](blob:https://gp-team.atlassian.net/ce6947d0-9962-476d-9221-a3e3fe0f833d) and repeat the procedure.

_**Example of Reservation Export:**_
