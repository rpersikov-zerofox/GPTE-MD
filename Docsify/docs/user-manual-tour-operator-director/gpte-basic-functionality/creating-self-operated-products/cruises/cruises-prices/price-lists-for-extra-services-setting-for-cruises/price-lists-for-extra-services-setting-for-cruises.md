# Price-Lists for Extra services setting for Cruises

To set up a price-list for cruise,

On **Products** → Cruise **Prices** tab → **Price-lists for Extra services** sub-tab click **Create**, *Price-list for extra services creating* page appears:

![2024-11-14_15-13-34.jpg](/assets/2024-11-14_15-13-34.jpg)

1.  Specify *the price-list for extra services name*, as well as the tariff, *the period* when it is active, *the description*and\* terms of use\*.
2.  Specify the rates and the availability of Extra services:

- **Availability**: select the conditions for service booking. The following items are available: \* **mandatory**: a tourist must book the Extra service, when booking the main service. \* **optional**: the service is offered to a tourist while booking the main service, but it is not mandatory. \* **not available**: the service is unavailable for booking and is not offered to a tourist.
- **Include into cancellation charges**: specify whether the price for an Extra service is included into the penalty charge in case the offer is canceled. If the check box is selected a tourist is charged along with the penalty of the service price.
