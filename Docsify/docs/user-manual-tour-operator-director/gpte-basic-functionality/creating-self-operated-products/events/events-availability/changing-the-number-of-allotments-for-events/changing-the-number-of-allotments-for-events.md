# Changing the Number of Allotments for Events
...
1.  On the **Availability** tab, in the **Quantity** group, click **Limited**, and then select the required function from the offered ones:
