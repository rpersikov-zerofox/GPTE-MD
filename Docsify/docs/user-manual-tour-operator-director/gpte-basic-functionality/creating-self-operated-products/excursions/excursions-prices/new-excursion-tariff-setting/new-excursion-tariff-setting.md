# New excursion tariff setting

To configure a tariff for a self-operated excursion,

1.  On the Products menu, click **Activities**.
2.  In the profile of the required excursion, go to the **Prices**tab.
3.  On the Prices tab, in the Tariff group, click **Create**. *Tariff creating* page appears:

![2024-11-12_10-49-06.jpg](/assets/2024-11-12_10-49-06.jpg)

4.  On the *Tariff creating* page, first specify the tariff description:
...
- **Currency**: specify the currency of the tariff.
