# Seat allotments settings for Tours
...
- **Set release**: release is the number of days after the booking when the supplier does not guarantee the allotment and therefore confirmation of the service availability from the supplier is required. *Let's consider the following example:* *Suppose today is January 1.* *You have an allotment for 10 units (10 hotel rooms or 10 seats on a charter flight, etc.)* *The release lasts for 7 days according to the agreement with a supplier.* *This means that you can book up to 10 services a day, starting from January 8.* *The bookings that are made from January 1 to January 7 are not confirmed automatically and are processed "upon request".*
...
2.  Set up operation parameters. You can select the following parameters:

![2024-11-13_13-03-41.png](/assets/2024-11-13_13-03-41.png)
...
- **Category**: room categories included into the allotment, for instance, the \"comfort\" category.
- **Service**: room types included into the allotment, for instance, \"single\".

3.  Specify the number of allocated units in the Quantity group.

![Screenshot 2020-10-16 at 22.51.37-20201016-195433.jpg](/assets/Screenshot-2020-10-16-at-22.51.37-20201016-195433.jpg)

When limiting the number of allocated units, select one of the following options:

- **On Request**: during the booking you should make an additional request about the availability of the service from the supplier. Instant confirmation of the service is unavailable.
...
Suppose you have an agreement with the supplier on 25 twin rooms of the **Standard** category to be booked from June 1 to June 30 and all rooms are offered upon request. To set this number of guaranteed allotments in the system:

1.  Set the time span from June 1 to 30.
2.  Select the required allotment, category and room type.
3.  In the Quantity group, click **Limited** and specify the number of rooms that you can offer.
4.  Click **Update**.

The number of guaranteed rooms that you set appears in a table report:
